...
- [x] 8.1 建立 admin.html — 管理員後台頁面（獨立 HTML，鐘鼎傳世主題）
- [x] 8.2 實作管理員登入驗證（檢查 JWT role=admin）
- [x] 8.3 實作儀表板：待���核數量、會員總數、族人總數
- [x] 8.4 實作「審核提交」面板：列表、通過/退回/修改後通過
- [x] 8.5 實作「會員管理」面板：列表、角色修改、停用
- [x] 8.6 實作「族人管理」面板：搜尋、編輯、刪除
